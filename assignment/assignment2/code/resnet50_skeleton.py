...
Original file is located at
    https://colab.research.google.com/drive/1GNdBzYp8L4QpLpctIx0ETorXajkRRWoZ
"""
...
class ResidualBlock(nn.Module):
    def __init__(self, in_channels, middle_channels, out_channels, downsample=False):
        ...
        if self.downsample:
            ...
            self.downsize = conv1x1(in_channels, out_channels, 2, 0)#수정불가
            ...
            self.make_equal_channel = conv1x1(in_channels, out_channels, 1, 0)#수정불가
...
class ResNet50_layer4(nn.Module):
    def __init__(self, num_classes= 10 ): # Hint : How many classes in Cifar-10 dataset?
        ...
        self.fc = nn.Linear(in_features=1024, out_features=10) # Hint : Think about the reason why fc layer is needed
